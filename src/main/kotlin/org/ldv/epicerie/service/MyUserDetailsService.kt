...
class MyUserDetailsService(private val utilisateurDAO: UtilisateurDAO) : UserDetailsService {
    ...
    override fun loadUserByUsername(username: String): UserDetails {
         ...
         */
        val leRole = utilisateur.role?.nom_role
        ...
        return org.springframework.security.core.userdetails.User
            .withUsername(utilisateur.email_utilisateur)   // Identifiant de connexion
            .password(utilisateur.mdp_utilisateur)         // Mot de passe hashé
