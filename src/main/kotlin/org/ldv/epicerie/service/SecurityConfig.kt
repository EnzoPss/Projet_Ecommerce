    ...
    fun filterChain(http: HttpSecurity): SecurityFilterChain {
        http
            ...
            .formLogin { form: FormLoginConfigurer<HttpSecurity?> ->
                form
                    .loginPage("/Ecommerce_Lepicerie/login").defaultSuccessUrl("/Ecommerce_Lepicerie/profil").failureUrl("/Ecommerce_Lepicerie/login?error=true")
                    .loginProcessingUrl("/Ecommerce_Lepicerie/login")
                    .permitAll()
            }
            ...
            .logout { logout: LogoutConfigurer<HttpSecurity?> ->
                logout
                    .logoutUrl("/Ecommerce_Lepicerie/logout")
